...
public extension RelayCache {
    ...
    class Tracker {
        ...
        public static let relayUpdateInterval: TimeInterval = 60 * 60
        ...
        public func getCachedRelays() throws -> CachedRelays {
            nslock.lock()
            defer { nslock.unlock() }
        ...
        public func addObserver(_ observer: RelayCacheObserver) {
            observerList.append(observer)
        }

        public func removeObserver(_ observer: RelayCacheObserver) {
